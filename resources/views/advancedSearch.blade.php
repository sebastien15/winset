                    ...
                    <div class="img-containerProperties">
                        ...
                        @for ($i = 0; $i < $imageproperties->count(); $i++)
                            @if ($property->id != $imageproperties[$i]->property_id )
                                @else
                            <a href="{{ route('property_description',$property->id) }}"><img src="{{ URL::asset("images/properties/{$imageproperties[$i]->name}") }}" style="height:100%; width:100%;"/></a>    
                                @break
                            @endif                                                                           
                        @endfor
                ...
                <div class="col-5">
                    <div class="img-container">
                        @for ($i = 0; $i < $imageproperties->count(); $i++)
                            @if ($property->id != $imageproperties[$i]->property_id)
                                @else
                                <a href="{{ route('property_description',$property->id) }}"><img src="{{ URL::asset("/images/properties/{$imageproperties[$i]->name}") }}"/></a>
                            @endif
                        @endfor

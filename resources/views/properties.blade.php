...
<link rel="stylesheet" type="text/css" media="screen" href="css/properties.css" />
                ...
                <div class="container">
                    <div class="simple-search-container">
                        <form method="Get" action="{{ route('userSearch.index') }}">
                            ...
                            <button type="submit">
                                <img src="images/icons/search.png" width="25" height="25"/>
                            </button>
                        </form>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="desc-container">                        
                        ...
                        <div class="buttons-section">
                            <button class="btns">{{ $property->currency }}. {{ $property->price }} </button>
